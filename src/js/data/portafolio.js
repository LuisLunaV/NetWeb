const portafolioInfo = [
  {
    ...
    ruta: "./src/assets/img/proyectos/",
    description: `Shake Shack Order System es una aplicación desarrollada para mejorar la experiencia del cliente en los restaurantes
